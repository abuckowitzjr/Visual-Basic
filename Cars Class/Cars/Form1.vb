...
Public Class Form1
    ...
    Private Sub btnAdd_Click(sender As System.Object, e As System.EventArgs) Handles btnAdd.Click
        ...
        Dim intYear As Integer = Integer.Parse(txtYear.Text)
        Dim strLine As String = strMake & "|" & strModel & "|" & intYear & Environment.NewLine
        Try
            Dim car1 As New Cars(strMake, strModel, intYear)
            Dim a As New WriteObjects(txtFileName.Text)
            a.Write(car1)
